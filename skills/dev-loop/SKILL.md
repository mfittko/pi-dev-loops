...
**Worktree fetch rule (#567, mandatory):** Always run `git fetch origin` before creating or reusing any worktree. Never create a worktree from a stale local `origin/main` reference. See `../../docs/worktree-guidance.md` for the full contract.
