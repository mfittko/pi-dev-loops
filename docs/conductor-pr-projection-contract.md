...
Use this rule:
- this file is a required runtime contract doc for installed `dev-loop` / `copilot-dev-loop` skill consumers and must be bundled under `docs/conductor-pr-projection-contract.md` beside the installed `SKILL.md`
