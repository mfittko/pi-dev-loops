...
- The default pre-approval review fan-out must use the DRY, KISS, and YAGNI lenses in parallel when practical before calling work review-complete, approval-ready, merge-ready, or ready for final handoff.
