...
test("resolveRepoWikiPaths returns deterministic helper paths under .tmp", () => {
  ...
  assert.equal(paths.cliPath, path.join("/repo", ".tmp", "repo-wiki", REPO_WIKI_REF, "source", "dist", "bin", "repo-wiki.js"));
  assert.equal(paths.buildStampPath, path.join("/repo", ".tmp", "repo-wiki", REPO_WIKI_REF, "build-stamp.json"));
});
