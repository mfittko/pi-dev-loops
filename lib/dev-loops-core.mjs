...
const SKILL_METADATA = {
  ...
  "copilot-dev-loop": {
    ...
    availableDetail: "Required internal Copilot PR follow-up compatibility seam is available.",
    unavailableDetail:
      "Run `/dev-loops install repo` or `/dev-loops install system` to install required internal routed compatibility seams.",
  },
  "copilot-autopilot": {
    id: "copilot-autopilot-skill",
    label: "Copilot issue-intake compatibility seam discoverable (internal/runtime)",
    availableDetail: "Required internal Copilot issue-intake compatibility seam is available.",
    unavailableDetail:
      "Run `/dev-loops install repo` or `/dev-loops install system` to install required internal routed compatibility seams.",
  },
};
...
export async function collectDevLoopChecks(runtime) {
  ...
  const copilotSkill = normalizeProbe(
    ...
    SKILL_METADATA["copilot-dev-loop"].availableDetail,
  ...
  const autopilotSkill = normalizeProbe(
    ...
    SKILL_METADATA["copilot-autopilot"].availableDetail,
