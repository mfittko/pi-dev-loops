...
/**
 * Canonical packaged skill directory names used by the shared dev-loops core,
 * the Pi extension wrapper, and the shell CLI wrapper. Treat this list as
 * immutable; shared type contracts derive from its stable contents.
 */
